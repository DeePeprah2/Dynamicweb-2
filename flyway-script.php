...
sudo aws s3 cp s3://dee-data-migration-bucket/V1__nest.sql /home/ec2-user/flyway-9.20.0/sql

# Run Flyway migration
sudo flyway -url=jdbc:mysql://newdb.c3qgmy74n7ea.eu-west-2.rds.amazonaws.com:3306/adwoadb \
  -user=dee \
  -password=dee12345 \
